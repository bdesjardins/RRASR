...
public class ExperimentalApplication {
	...
	private void initialize() {
		...
		frmCsiProject.setBounds(100, 100, 930, 700);
		frmCsiProject.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(192, 36, 525, 580);
		
		JLabel lblExperimentalRunner = new JLabel("RRASR Experiment Runner");
		lblExperimentalRunner.setBounds(343, 0, 227, 23);
		lblExperimentalRunner.setFont(new Font("Tahoma", Font.PLAIN, 19));
		frmCsiProject.getContentPane().setLayout(null);
		
		JPanel parametersPanel = new JPanel();
		parametersPanel.setBounds(10, 36, 172, 580);
		frmCsiProject.getContentPane().add(parametersPanel);
		...
		JTree instanceSelector = new JTree();
		instanceSelector.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(0, 0, 0)));
		instanceSelector.setRootVisible(false);
		...
		gl_parametersPanel.setHorizontalGroup(
			gl_parametersPanel.createParallelGroup(Alignment.LEADING)
				.addComponent(lblProblemInstance, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
				.addGroup(Alignment.TRAILING, gl_parametersPanel.createSequentialGroup()
					...
					.addGroup(gl_parametersPanel.createParallelGroup(Alignment.LEADING)
						.addComponent(lblAlgorithm, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
						.addComponent(populationField, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
						.addComponent(algorithmSpinner, 0, 152, Short.MAX_VALUE)
						.addComponent(lblPopulationSize, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
						.addComponent(generationsField, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
						.addComponent(lblOfGenerations, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE))
					.addContainerGap())
				.addGroup(gl_parametersPanel.createSequentialGroup()
					.addContainerGap()
					.addComponent(instanceSelector, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_parametersPanel.setVerticalGroup(
			gl_parametersPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_parametersPanel.createSequentialGroup()
					...
					.addComponent(instanceSelector, GroupLayout.PREFERRED_SIZE, 384, GroupLayout.PREFERRED_SIZE)
		...
		resultsPanel.setBounds(727, 36, 172, 580);
		frmCsiProject.getContentPane().add(resultsPanel);
		...
		gl_resultsPanel.setHorizontalGroup(
			gl_resultsPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_resultsPanel.createSequentialGroup()
					...
					.addContainerGap())
				.addGroup(Alignment.TRAILING, gl_resultsPanel.createSequentialGroup()
					.addContainerGap()
		...
		frmCsiProject.getContentPane().add(tabbedPane);
		...
		frmCsiProject.getContentPane().add(lblExperimentalRunner);
