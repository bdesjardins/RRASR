...
import jmetal.core.*;
import jmetal.metaheuristics.age.AGE;
...
//    }
    ...
    public InfoPrinter2(Algorithm algorithm, Problem problem, String subdir, int lastPrintedEvalsFile, int lastPrintedEvalsScreen) {
    ...
    public InfoPrinter2(Algorithm algorithm, Problem problem, String subdir) {
...
//        System.out.println(algorithm.getClass().getSimpleName());
        ...
        try {
            ...
            Logger.getLogger(InfoPrinter2.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }
        ...
        if (!doNotCalculateAnything) {
            ...
            double approximation = AGE.computeApproximation(solutionSet, archive)[0];
