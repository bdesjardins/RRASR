  ...
  public Solution[] doCrossover(double probability,
    ...
    if (PseudoRandom.randDouble() < probability) {
      ...
      for (int i = 0; i < permutationLength; i++)
        replacement1[i] = replacement2[i] = -999999;
      ...
      for (int i = cuttingPoint1; i <= cuttingPoint2; i++) {
        ...
        replacement1[Math.abs(parent2Vector[i])] = parent1Vector[i];
        replacement2[Math.abs(parent1Vector[i])] = parent2Vector[i];
      } // for
      ...
      for (int i = 0; i < permutationLength; i++) {
        ...
        int m1 = replacement1[Math.abs(n1)];
