 ...
 */
public class Permutation_Old implements Variable {
	 ...
	 */
	public Permutation_Old(int size) {
		super();
	 ...
	 *         permutation
	 */
	public Permutation_Old(int[] permutation) {
		super();
	...
	public Permutation_Old(int size, ArrayList<Integer> sensingHoles) {
		super();
	...
	@Override
	public Permutation_Old copy() {
		return new Permutation_Old(permutation);
	}
...
//			}
	...
	public boolean equals(Object obj) {
		if (obj == this) {
			...
			Permutation_Old rhs = (Permutation_Old)obj;
