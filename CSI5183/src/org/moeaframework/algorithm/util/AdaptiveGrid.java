...
public class AdaptiveGrid {
  ...
  */
  private void updateLimits(Population solutionSet){          
   ...
   * @param solutionSet The <code>SolutionSet</code> considered.
   */
  private void addSolutionSet(Population solutionSet){
   ...
   */
  public void updateGrid(Population solutionSet){	   
   ...
   */
  public void updateGrid(Solution solution, Population solutionSet){	   
